...
1. Copy the included `SpawnRestrictions.dll` to `BepInEx/plugins/` on the host or server and every client.
...
Install `bin/Release/net472/SpawnRestrictions.dll` using the steps above.
